    ...
    <div class="photo-edit" style="margin-bottom:18px">
      ...
      <div>
        <div style="display:flex;gap:6px;flex-wrap:wrap">
          ...
          ${photoOf(s.id) ? `<button type="button" class="btn btn-sm" id="recropPhoto">✂️ 다시 자르기</button>
